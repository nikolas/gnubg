 ...
 *
 * $Id: makebearoff.c,v 1.56 2007/12/18 21:48:04 Superfly_Jon Exp $
 */
...
version ( void ) {
#ifndef WIN32
  printf ( "makebearoff $Revision: 1.56 $\n" );
#else
  MessageBox( NULL, "makebearoff $Revision: 1.56 $\n", "Makebearoff", MB_OK );
#endif
}
...
extern int main( int argc, char **argv )
{
  ...
  if ( nOS ) {
    ...
    dlgprintf(131, "makebearoff $Revision: 1.56 $" );
#else
    fprintf ( stderr, 
