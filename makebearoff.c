 ...
 *
 * $Id: makebearoff.c,v 1.44 2007/07/14 20:45:14 c_anthon Exp $
 */
...
version ( void ) {
#ifndef WIN32
  printf ( "makebearoff $Revision: 1.44 $\n" );
#else
  MessageBox( NULL, "makebearoff $Revision: 1.44 $\n", "Makebearoff", MB_OK );
#endif
}
...
extern int main( int argc, char **argv ) {
  ...
  if ( nOS ) {
    ...
    dlgprintf(131, "makebearoff $Revision: 1.44 $" );
#else
    fprintf ( stderr, 
